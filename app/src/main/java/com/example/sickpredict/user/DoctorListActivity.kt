...
class DoctorListActivity : AppCompatActivity(), PaymentResultListener {
    ...
    private fun makepayment() {
        ...
        try {
            ...
            options.put("name", "Medical Virtual Assistant")
            ...
            options.put("prefill.email", "moderncoe@example.com")
    ...
    private fun subscribeUi() {
        tts = TextToSpeech(applicationContext) { i ->
            if (i == TextToSpeech.SUCCESS) {
                val textToSpeak = "मेडिकल वर्चुअल असिस्टंट मध्ये आपले स्वागत आहे. आपण दिलेली लक्षणे आहेत ${prediction.symtomps}.आपणास ${prediction.prediction}या रोगाचे निदान झाले आहे. तरी पुढील डॉक्टरांचा सल्ला घेण्याची प्रक्रिया पेड असेल.....धन्यवाद."
